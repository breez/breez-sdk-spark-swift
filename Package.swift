...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "breez_sdk_sparkFFI", url: "https://github.com/breez/breez-sdk-spark-swift/releases/download/0.21.1/breez_sdk_sparkFFI.xcframework.zip", checksum: "11df79469ae06a55d4c4bbcbeeab9e09438ec2279abaf67c988038661fdb0474"),
